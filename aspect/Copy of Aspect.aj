...
//				System.out.println(input.readLine());
	...
	pointcut advice () :  call (* *.*(..))  && !within(Aspect);
	
	pointcut adviceRandoop () :  execution (* *.*(..))  && !within(Aspect);
...
//						out.write(("covered impacted method: "+im));
						
						System.err.println("covered impacted method: "+im);
