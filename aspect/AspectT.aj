...
public aspect AspectT {
	...
	private File logResultCoverage = new File("C:/Users/Felipe/Documents/resultados/aspectCoverageT.txt");
...
//				System.out.println(input.readLine());
	...
	pointcut adviceCall () :  call (* *.*(..))  && !within(AspectT);
	
	pointcut adviceExecution () :  execution (* *.*(..))  && !within(AspectT);
