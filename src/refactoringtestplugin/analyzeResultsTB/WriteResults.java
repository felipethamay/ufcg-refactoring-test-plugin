...
public class WriteResults {
	...
	static List<Integer> NULL_POINTER_ = new ArrayList<Integer>();
	...
	static String checkMessage(String path, int i ) {
		...
		if (f.isDirectory()) {
			...
			for (String string : list) {
				...
				} else if (string.contains(REFACTOR_EXECUTION_ERROR) || string.contains(ENGINE_CRASH)) {
				...
				} else if (string.contains(NULL_POINTER)) {
					NULL_POINTER_.add(i);
					return NULL_POINTER;
				} 
	...
	public static void writeResults(String path, String path2, int numberOfPrograms, String tool) {
		...
		try {
			...
			outfile.writeLine("NULL_POINTER\n");
			outfile.writeLine(NULL_POINTER_.toString()+"\n");
	...
	public static void main(String[] args) {
		...
		String p = "C:/Users/Felipe/Documents/doutorado/bug_transf/results_exp/EncapsulateField/Alloy/";
//		p = "C:/Users/Felipe/Documents/doutorado/bug_transf/results_exp/jrrt/pullupmethod/skip1/";
		String p2 = "C:/Users/Felipe/Documents/doutorado/bug_transf/results_exp/EncapsulateField/results.txt";
//		p2 = "C:/Users/Felipe/Documents/doutorado/bug_transf/results_exp/jrrt/pullupmethod/results.txt";
		...
		//Tempo total: 14059s (3.9h) - jrrt push down method - skip 10
		//Tempo total: 0.80h - eclipse push down method - skip 10
		// tempo total: 33752s (9.3h) - jrrt pull up method - skip25
		//tempo total: 8.72h - eclipse pull up method - skip25
		//tempo total: 10.72h - eclipse pull up field - skip25 
	}
}
