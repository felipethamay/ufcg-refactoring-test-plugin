...
public abstract class DisableOverridingTest extends RefactoringTest_ {

	protected static final String TARGET_METHOD_NAME = "methodid_1";
	protected static final String CLASS_NAME = "ClassId_0.java";
...
//				if (type.getFullyQualifiedName().endsWith(CLASS_NAME))
				for (IMethod method : type.getMethods()) {
					...
					if (method.getParameterTypes().length == 1 && method.getElementName().equals(TARGET_METHOD_NAME) &&
							icu.getElementName().equals(CLASS_NAME)) {
