package refactoringtestplugin.disable_implicit_cast;
...
public class Alloy extends DisableImplicitCastTest {
	...
	protected IGenerator<List<CompilationUnit>> getCUGen() {
		...
		JDolly jdolly = new JDollyNoField(pluginFolder + 
				"/../program_counter/alloyTheory3/disable_implicit_cast.als",
				1, 2, 4);
		return jdolly;
	}
