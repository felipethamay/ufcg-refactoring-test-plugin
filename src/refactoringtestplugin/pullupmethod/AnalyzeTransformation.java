...
public class AnalyzeTransformation extends AnalyzeTransformationInfo{
	...
	public boolean isTransformationBug(String source, String target, String methodName, String clasName) {
		this.source = source;
		this.target = target;
		...
		if (cTarget != null) {
			if (cSource.getFullName().equals(cTarget.getFullName())) {
				problem.append("o metodo nao saiu da subclasse. A classe do source é abstrata: "+cSource.isAbstract()+
...
//				System.out.println(problem);
			...
			if (!superClass.equals(cTarget.getClassName())) {
				problem.append("a classe que o metodo foi nao é superclasse\n");
				transformationBug = true;
			}
	...
	public static void main(String[] args) {
		...
		System.out.println(a.isTransformationBug(source, target, "k", "B"));
