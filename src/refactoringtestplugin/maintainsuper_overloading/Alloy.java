package refactoringtestplugin.maintainsuper_overloading;
...
public class Alloy extends MaintainSuperOverloadingTest {
	...
	protected IGenerator<List<CompilationUnit>> getCUGen() {
		...
		JDolly jdolly = new JDollyNoField(pluginFolder + 
				"/../program_counter/alloyTheory3/maintainsuper_overloading.als",
				2, 3, 4);
		return jdolly;
	}
