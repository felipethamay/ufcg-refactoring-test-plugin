...
public class Method extends Entity{
	...
	//instrucoes do metodo
	List<Object> text = new ArrayList<Object>();
	
	//esse atributo s— serve para methodInvoc
					...
					if (getField || putField) {
						...
						for (Field field : fieldInvoc) {
							...
							if (field.getFullName().equals(writtenFieldName)) {
								...
								//s— colocar no map se ele for escrito, pois nao vai interessar
								//saber que um field lido mudou
								// o objetivo Ž colocar o field como impactado se ele mudar a escrita
...
//		            System.out.println("NÌO Ž numero");  
		        } 
			} else {
				instruction += inst;
			}
